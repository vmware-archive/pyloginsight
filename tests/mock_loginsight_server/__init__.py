...
class LogInsightMockAdapter(MockedExampleObjectMixin, MockedVersionMixin, MockedLicensesMixin, MockedSessionsMixin, MockedAuthProvidersMixin, requests_mock.Adapter):
    pass
